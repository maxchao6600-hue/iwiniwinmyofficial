...
const en: Record<RouteKey, RouteSeo> = {
  ...
  "about-iwin": { title: "About IWIN Malaysia | Partner Information Website", description: "Understand the IWIN ecosystem and the limited role of this Malaysian official partner information website." },
  ...
  "games-slots": { title: "IWIN Malaysia Slot Games | Games & Guide", description: "Learn common slot features, volatility concepts and safer-play checks before visiting an external IWIN platform." },
  ...
  faqs: { title: "IWIN Malaysia FAQ | Registration, Payment & Account Help", description: "Clear answers on accounts, registration, payments, games, promotions, agents, security and mobile access." },
