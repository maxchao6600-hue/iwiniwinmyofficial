...
const copy: Record<Locale, VisualContent> = {
  en: {
    ...
    responsible: {
      headline: "Responsible gaming framework",
      items: [
        { title: "Time", description: "Set time limits before you play." },
        { title: "Spending", description: "Set spending limits you can afford." },
        { title: "Breaks", description: "Pause when play stops feeling enjoyable." },
        { title: "Awareness", description: "Treat games as entertainment, not income." },
        { title: "Support", description: "Use platform tools and seek help when needed." },
      ],
    },
  ...
  ms: {
    ...
    responsible: {
      headline: "Rangka permainan bertanggungjawab",
      items: [
        ...
        { title: "Rehat", description: "Berhenti apabila permainan tidak lagi menyeronokkan." },
        { title: "Kesedaran", description: "Anggap permainan sebagai hiburan, bukan pendapatan." },
        { title: "Sokongan", description: "Gunakan alat platform dan dapatkan bantuan bila perlu." },
      ],
    },
  ...
  zh: {
    ...
    responsible: {
      ...
      items: [
        ...
        { title: "意识", description: "将游戏视为娱乐，而非收入来源。" },
        { title: "支持", description: "使用平台工具，必要时寻求帮助。" },
      ],
    },
